...
export namespace Prisma {
  ...
  */
  ...
  export type FileUploadGroupByArgs = {
    ...
    by: Array<FileUploadScalarFieldEnum>
  ...
  type GetFileUploadGroupByPayload<T extends FileUploadGroupByArgs> = PrismaPromise<
    Array<
  ...
  export type FileUploadGetPayload<S extends boolean | null | undefined | FileUploadArgs, U = keyof S> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
  ...
  type FileUploadCountArgs = Merge<
  ...
  export interface FileUploadDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
    ...
    ): PrismaPromise<Array<FileUploadGetPayload<T>>>
    ...
    **/
    ...
    /**
     * Find one FileUpload that matches the filter or throw
     * `NotFoundError` if no matches were found.
    ...
    **/
     ...
     * })
    **/
    aggregate<T extends FileUploadAggregateArgs>(args: Subset<T, FileUploadAggregateArgs>): PrismaPromise<GetFileUploadAggregateType<T>>
    ...
    **/
    ...
    >(args: SubsetIntersection<T, FileUploadGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetFileUploadGroupByPayload<T> : PrismaPromise<InputErrors>
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__FileUploadClient<T, Null = never> implements PrismaPromise<T> {
    [prisma]: true;
    private readonly _dmmf;
    private readonly _fetcher;
    private readonly _queryType;
   ...
   */
  export type FileUploadFindUniqueOrThrowArgs = FileUploadFindUniqueArgsBase
      

  /**
   * FileUpload: findFirstOrThrow
   */
  export type FileUploadFindFirstOrThrowArgs = FileUploadFindFirstArgsBase
